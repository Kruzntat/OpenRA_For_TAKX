...
label-mainmenu-cot-prompt-title = Establishing Battlefield Control
label-mainmenu-cot-prompt-text-a = OpenRA now includes optional developer Chain-of-Thought tooling.
label-mainmenu-cot-prompt-text-b = Press Continue to proceed.
