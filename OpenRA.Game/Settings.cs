...
namespace OpenRA
{
	...
	public class DebugSettings
	{
		...
		[Desc("Enable showing the Chain-of-Thought developer prompt on startup.")]
		public bool ShowChainOfThoughtPrompt = true;

		[Desc("Version of the Chain-of-Thought prompt that the player last viewed.")]
		public int ChainOfThoughtPromptVersion = 0;
	}
